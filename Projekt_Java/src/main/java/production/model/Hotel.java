...
public class Hotel extends Accommodation implements RoomAccommodation {

    Integer numberOfPassengersPerRoom;

    public Hotel(Long id, String name, Address address, BigDecimal regularPricePerNight, Discount discount, BigDecimal reducedPricePerNight, LocalDate checkInDate, LocalDate checkOutDate, Set<Passenger> passengers, Integer numberOfPassengersPerRoom) {
    ...
    public Hotel(Accommodation accommodation,Integer numberOfPassengersPerRoom) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(numberOfPassengersPerRoom, hotel.numberOfPassengersPerRoom);
    }
